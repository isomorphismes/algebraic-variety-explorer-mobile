...
//        dcsd.realRootFinder = new GPUSuitableDescartesRootFinder2( false );
    	...
    	int bg = ColorInt.toArgb( dcsd.backgroundColor );
    ...
    public CPUAlgebraicSurfaceRenderer()
    {
        ...
        int workerCount = Math.min( 4, Math.max( 1, Runtime.getRuntime().availableProcessors() ) );
        this.threadPoolExecutor = Executors.newFixedThreadPool( workerCount, new PriorityThreadFactory() );
