            ...
            case OG_1x1:
            {
                ...
                for( int y = 0; y < internal_height; y++ )
                {
                    ...
                    for( int x = 0; x < internal_width; x++ )
                    {
                        ...
                        dcsd.colorBuffer[ dcsd.width * ( yStart + y ) + xStart + x ] = ColorInt.toArgb( tracePolynomial( scs, gcs, u, v ) );
                ...
                for( int y = 0; y < internal_height; ++y )
                {
                    ...
                    for( int x = 0; x < internal_width; ++x )
                    {
                        ...
                        if( x > 0 && y > 0 )
                        {
                            ...
                            dcsd.colorBuffer[ ( yStart + y - 1 ) * dcsd.width + ( xStart + x - 1 ) ] = ColorInt.toArgb( antiAliasPixel( u - u_incr, v - v_incr, u_incr, v_incr, dcsd.antiAliasingPattern, ulColor, urColor, llColor, lrColor, csp_hm ) );
                        }
                    }
                }
            }
